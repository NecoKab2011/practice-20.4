...
var _getPostsJs = require("./get-posts.js");
var _createPostsJs = require("./create-posts.js");
var _updatePostsJs = require("./update-posts.js");
var _deletePostsJs = require("./delete-posts.js");
var _commentPostsJs = require("./comment-posts.js");
const postsList = document.querySelector("#postsContainer");
const createPostForm = document.querySelector("#createPostForm");
const titleInput = document.querySelector("#titleInput");
const contentInput = document.querySelector("#contentInput");
async function renderPosts() {
    const posts = await (0, _getPostsJs.getPosts)();
    postsList.innerHTML = "";
    posts.forEach((post)=>{
...
createPostForm.addEventListener("submit", async (e)=>{
    ...
    if (title && content) {
        await (0, _createPostsJs.createPost)(title, content);
        await renderPosts();
...
postsList.addEventListener("click", async (e)=>{
    if (e.target.classList.contains("delete-post-btn")) {
        ...
        await (0, _deletePostsJs.deletePost)(id);
        await renderPosts();
    }
    if (e.target.classList.contains("edit-post-btn")) {
        ...
        if (newTitle && newContent) {
            await (0, _updatePostsJs.updatePost)(id, newName, newTitle, newContent);
            await renderPosts();
        }
    }
});
postsList.addEventListener("submit", async (e)=>{
    if (e.target.classList.contains("create-comment-form")) {
        ...
        if (commentText) {
            await (0, _commentPostsJs.addComment)(postId, commentText);
            await renderPosts();
        }
    }
});
...
},{"./get-posts.js":"itfdI","./create-posts.js":"hBCQh","./update-posts.js":"la0zj","./delete-posts.js":"6YcjY","./comment-posts.js":"3h1Jt"}],"itfdI":[function(require,module,exports,__globalThis) {
...
},{}],"hBCQh":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"la0zj":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updatePost", ()=>updatePost);
async function updatePost(id, userName, title, content) {
    try {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6YcjY":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3h1Jt":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequirea4d4", {})

//# sourceMappingURL=practice-20.4.31b563d9.js.map
